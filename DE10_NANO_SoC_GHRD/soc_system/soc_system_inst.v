	soc_system u0 (
		...
		.hallsensordetector_0_frontlefthall_import  (<connected-to-hallsensordetector_0_frontlefthall_import>),  //  hallsensordetector_0_frontlefthall.import
		.hallsensordetector_0_frontrighthall_import (<connected-to-hallsensordetector_0_frontrighthall_import>), // hallsensordetector_0_frontrighthall.import
		.hallsensordetector_0_rearlefthall_1_import (<connected-to-hallsensordetector_0_rearlefthall_1_import>), // hallsensordetector_0_rearlefthall_1.import
		.hallsensordetector_0_rearrighthall_import  (<connected-to-hallsensordetector_0_rearrighthall_import>),  //  hallsensordetector_0_rearrighthall.import
		...
		.pwmbrushed_0_direction_export              (<connected-to-pwmbrushed_0_direction_export>),              //              pwmbrushed_0_direction.export
		.pwmbrushed_0_magnitude_export              (<connected-to-pwmbrushed_0_magnitude_export>),              //              pwmbrushed_0_magnitude.export
		...
		.upcounter_0_conduit_end_export             (<connected-to-upcounter_0_conduit_end_export>),             //             upcounter_0_conduit_end.export
		.pwmservo_1_conduit_end_export              (<connected-to-pwmservo_1_conduit_end_export>),              //              pwmservo_1_conduit_end.export
		.pwmbrushed_1_direction_export              (<connected-to-pwmbrushed_1_direction_export>),              //              pwmbrushed_1_direction.export
		.pwmbrushed_1_magnitude_export              (<connected-to-pwmbrushed_1_magnitude_export>),              //              pwmbrushed_1_magnitude.export
		.pwmbrushed_2_direction_export              (<connected-to-pwmbrushed_2_direction_export>),              //              pwmbrushed_2_direction.export
		.pwmbrushed_2_magnitude_export              (<connected-to-pwmbrushed_2_magnitude_export>),              //              pwmbrushed_2_magnitude.export
		.pwmbrushed_3_direction_export              (<connected-to-pwmbrushed_3_direction_export>),              //              pwmbrushed_3_direction.export
		.pwmbrushed_3_magnitude_export              (<connected-to-pwmbrushed_3_magnitude_export>)               //              pwmbrushed_3_magnitude.export
	);
